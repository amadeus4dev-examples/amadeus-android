...
import com.amadeus.android.domain.air.models.DelayPrediction
...
interface FlightDelayPredictionApi {
    ...
    suspend fun getFlightDelayPrediction(
        ...
        @retrofit2.http.Query("departureDate") departureDate: LocalDate,
        @retrofit2.http.Query("departureTime") departureTime: ZonedDateTime,
        @retrofit2.http.Query("arrivalDate") arrivalDate: LocalDate,
        @retrofit2.http.Query("arrivalTime") arrivalTime: ZonedDateTime,
