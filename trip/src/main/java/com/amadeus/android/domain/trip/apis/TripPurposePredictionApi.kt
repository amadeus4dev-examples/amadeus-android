...
import com.amadeus.android.domain.trip.models.PurposePrediction
...
interface TripPurposePredictionApi {
    ...
    suspend fun getTripPurposePrediction(
        ...
        @retrofit2.http.Query("returnDate") returnDate: LocalDate,
        @retrofit2.http.Query("searchDate") searchDate: LocalDate?
    ): ApiResponse<PurposePrediction>
}
