...
import com.amadeus.android.domain.trip.models.AggregatedTrip
import com.amadeus.android.domain.trip.models.BodyTripParserJob
import com.amadeus.android.domain.trip.models.TripParserJobIn
import com.amadeus.android.domain.trip.models.TripParserJobOut
...
interface TripParserJobsApi {
    ...
    suspend fun createTripParserJob(
        @retrofit2.http.Body body: BodyTripParserJob
    ): ApiResponse<TripParserJobIn>
    /**
